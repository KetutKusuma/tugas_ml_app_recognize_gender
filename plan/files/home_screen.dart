...
//       onTick: (sec) => setState(() => _countdown = AudioService.maxDurationSec - sec),
//     );

//     if (!mounted) return;

//     if (path == null) {
//       setState(() { _state = AppState.error; _errorMsg = 'Gagal merekam audio.'; });
//       return;
//     }

//     setState(() { _wavPath = path; _state = AppState.processing; });
//     await _sendToApi(path);
//   }

//   // ── Pilih file audio ──────────────────────────────────
//   Future<void> _pickFile() async {
//     setState(() { _state = AppState.processing; _result = null; });
...
//       if (!mounted) return;
//       setState(() { _result = result; _state = AppState.result; });
//     } on Exception catch (e) {
//       final msg = e.response?.data?['message'] ?? e.message ?? 'Koneksi gagal';
//       setState(() { _state = AppState.error; _errorMsg = msg; });
//     } catch (e) {
...
//               )),
//           const SizedBox(height: 8),
//           Text('Rekam suara atau pilih file audio\nmaks 3 detik',
...
//               ),
//               child: const Icon(Icons.mic_rounded,
//                   color: Color(0xFFE53935), size: 60),
//             ),
//           ),
//           const SizedBox(height: 32),
...
//           ),
//           SizedBox(height: 24),
//           Text('Menganalisis suara...',
//               style: TextStyle(
//                   fontSize: 16, color: Color(0xFF1A1A2E),
//                   fontWeight: FontWeight.w500)),
//           SizedBox(height: 8),
//           Text('Mengirim ke server & prediksi',
